...
import com.test.sixpro.receiver.SMSReceiver;
...
//        }
    ...
    public void SendMessage(String strDestAddress, String strMessage) {
        ...
        try {
            ...
            PendingIntent mSendPI = PendingIntent.getBroadcast(mContext, 0, itSend, PendingIntent.FLAG_ONE_SHOT);
            smsManager.sendTextMessage(strDestAddress, null, strMessage, mSendPI, null);
            LogInfo.log("wwn", "发送");

        } catch (Exception e) {
            e.printStackTrace();
            LogInfo.log("wwn", "发送异常");
        }
    }
